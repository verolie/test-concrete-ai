...
model AccountDetail {
  ...
  prin_pan       String @db.VarChar(50)
  acct_typ       String @db.VarChar(2)
  actv_typ       String @db.VarChar(1)
  blnc_amt       Float  @db.DoublePrecision
  loan_amt       Float  @db.DoublePrecision
  cycc_day       Int
  min_loan_pymnt Float  @db.DoublePrecision
